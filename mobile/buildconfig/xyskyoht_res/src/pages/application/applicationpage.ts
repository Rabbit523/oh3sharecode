...
export class ApplicationPage extends ApplicationBase {
    ...
    constructor(public navCtrl: NavController, public events: Events, public eventListSer: BugsListService
    ...
    SetApplicationPageList(): ActionPageListGroup[] {
        return [
            new ActionPageListGroup("个人", [ApplicationFirstBasePage.myunfinished]),
            new ActionPageListGroup("团队", [ApplicationFirstBasePage.supervise, ApplicationFirstBasePage.teamevent, ApplicationFirstBasePage.allevent])
        ];
    }

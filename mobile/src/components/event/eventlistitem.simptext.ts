...
@Component({
  selector: 'eventlistitemsimptext',
  templateUrl: 'eventlistitem.simptext.html', // 'eventlistitem1.component.html',  
})

export class EventListItemSimpText extends EventListItemBase {
  @Output()

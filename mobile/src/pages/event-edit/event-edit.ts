...
export class EventEditPage extends EventEditBasePage {
  constructor(public navParams: NavParams, protected view: ViewController, public events: Events, public alert: AlertController
